...
write.csv(coefficients_df, "cleaneddata/regress/co_abs_delta.csv")
...
write.csv(coefficients_long, "cleaneddata/regress/co_abs_nondelta.csv")
...
write.csv(coefficients_long, "cleaneddata/regress/co_percent_expend_delta.csv")
...
write.csv(coefficients_long, "cleaneddata/regress/co_percent_expend_nondelta.csv")
...
write.csv(coefficients_long, "cleaneddata/regress/co_percent_income_delta.csv")
...
write.csv(abs_delta, "cleaneddata/regress/abs_delta_r.csv")
##round 4 nondelta --------------------------------------------
regressions <- list(
  lm(supermarketwhole_expend ~ income_weekly + locally_grown + organic + local_econ + afford +
...
write.csv(abs_nondelta, "cleaneddata/regress/abs_nondelta_r.csv")
